...
export class VTeamSeasonAvgBoxscore implements Table {
    ...
    getName(): string {
        return 'v_team_season_avg_boxscore';
    }

    fromDbValues(values: any): VTeamSeasonAvgBoxscore {
        const newVTeamSeasonAvgBoxscore = new VTeamSeasonAvgBoxscore();
        newVTeamSeasonAvgBoxscore.team_id = values.team_id;
        newVTeamSeasonAvgBoxscore.league_year_id = values.league_year_id;
        newVTeamSeasonAvgBoxscore.league_id = values.league_id;
        newVTeamSeasonAvgBoxscore.games = values.games;
        newVTeamSeasonAvgBoxscore.fouls_committed = values.fouls_committed;
        newVTeamSeasonAvgBoxscore.fouls_received = values.fouls_received;
        newVTeamSeasonAvgBoxscore.points = values.points;
        newVTeamSeasonAvgBoxscore.made_2pt = values.made_2pt;
        newVTeamSeasonAvgBoxscore.missed_2pt = values.missed_2pt;
        newVTeamSeasonAvgBoxscore.pct_2pt = values.pct_2pt;
        newVTeamSeasonAvgBoxscore.made_3pt = values.made_3pt;
        newVTeamSeasonAvgBoxscore.missed_3pt = values.missed_3pt;
        newVTeamSeasonAvgBoxscore.pct_3pt = values.pct_3pt;
        newVTeamSeasonAvgBoxscore.made_ft = values.made_ft;
        newVTeamSeasonAvgBoxscore.missed_ft = values.missed_ft;
        newVTeamSeasonAvgBoxscore.pct_ft = values.pct_ft;
        newVTeamSeasonAvgBoxscore.off_reb = values.off_reb;
        newVTeamSeasonAvgBoxscore.def_reb = values.def_reb;
        newVTeamSeasonAvgBoxscore.blocks_made = values.blocks_made;
        newVTeamSeasonAvgBoxscore.blocks_suffered = values.blocks_suffered;
        newVTeamSeasonAvgBoxscore.turnovers = values.turnovers;
        newVTeamSeasonAvgBoxscore.steals = values.steals;
        newVTeamSeasonAvgBoxscore.assists = values.assists;
        return newVTeamSeasonAvgBoxscore;
    }
