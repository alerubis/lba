...
export class VPlayerGameMinuteBoxscoreBase implements Table {
    ...
    fromDbValues(values: any): VPlayerGameMinuteBoxscoreBase {
        ...
        newVPlayerGameMinuteBoxscoreBase.minute = values.minute;
        newVPlayerGameMinuteBoxscoreBase.fouls_committed = values.fouls_committed;
        newVPlayerGameMinuteBoxscoreBase.fouls_received = values.fouls_received;
        ...
        newVPlayerGameMinuteBoxscoreBase.off_reb = values.off_reb;
        newVPlayerGameMinuteBoxscoreBase.def_reb = values.def_reb;
        newVPlayerGameMinuteBoxscoreBase.blocks_made = values.blocks_made;
        newVPlayerGameMinuteBoxscoreBase.blocks_suffered = values.blocks_suffered;
        newVPlayerGameMinuteBoxscoreBase.turnovers = values.turnovers;
        newVPlayerGameMinuteBoxscoreBase.steals = values.steals;
        newVPlayerGameMinuteBoxscoreBase.assists = values.assists;
