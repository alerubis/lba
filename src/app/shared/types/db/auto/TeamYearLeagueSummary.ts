...
export class TeamYearLeagueSummary implements Table {
    ...
    getName(): string {
        return 'team_year_league_summary';
    }

    fromDbValues(values: any): TeamYearLeagueSummary {
        const newTeamYearLeagueSummary = new TeamYearLeagueSummary();
        newTeamYearLeagueSummary.team_id = values.team_id;
        newTeamYearLeagueSummary.team_name = values.team_name;
        newTeamYearLeagueSummary.league_year_id = values.league_year_id;
        newTeamYearLeagueSummary.league_id = values.league_id;
        newTeamYearLeagueSummary.league_name = values.league_name;
        newTeamYearLeagueSummary.total_sub_plays = DbUtils.epochToDate(values.total_sub_plays);
        newTeamYearLeagueSummary.total_shots = values.total_shots;
        newTeamYearLeagueSummary.one_point_shots_made = values.one_point_shots_made;
        newTeamYearLeagueSummary.one_point_shots_miss = values.one_point_shots_miss;
        newTeamYearLeagueSummary.two_point_shots_made = values.two_point_shots_made;
        newTeamYearLeagueSummary.two_point_shots_miss = values.two_point_shots_miss;
        newTeamYearLeagueSummary.three_point_shots_made = values.three_point_shots_made;
        newTeamYearLeagueSummary.three_point_shots_miss = values.three_point_shots_miss;
        newTeamYearLeagueSummary.one_point_shot_perc = values.one_point_shot_perc;
        newTeamYearLeagueSummary.two_point_shot_perc = values.two_point_shot_perc;
        newTeamYearLeagueSummary.three_point_shot_perc = values.three_point_shot_perc;
        newTeamYearLeagueSummary.total_fouls = values.total_fouls;
        newTeamYearLeagueSummary.total_infractions = values.total_infractions;
        newTeamYearLeagueSummary.total_turnovers = values.total_turnovers;
        newTeamYearLeagueSummary.total_defensive_rebounds = values.total_defensive_rebounds;
        newTeamYearLeagueSummary.total_offensive_rebounds = values.total_offensive_rebounds;
        newTeamYearLeagueSummary.total_assists = values.total_assists;
        newTeamYearLeagueSummary.total_blocks = values.total_blocks;
        newTeamYearLeagueSummary.total_timeouts = values.total_timeouts;
        return newTeamYearLeagueSummary;
    }
