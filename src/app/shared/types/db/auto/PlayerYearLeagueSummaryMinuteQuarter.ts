...
export class PlayerYearLeagueSummaryMinuteQuarter implements Table {
    ...
    fromDbValues(values: any): PlayerYearLeagueSummaryMinuteQuarter {
        ...
        newPlayerYearLeagueSummaryMinuteQuarter.minute_in_quarter = values.minute_in_quarter;
        newPlayerYearLeagueSummaryMinuteQuarter.total_sub_plays = values.total_sub_plays;
    ...
    toDbValues(): any {
        return {
            ...
            minute_in_quarter: this.minute_in_quarter,
